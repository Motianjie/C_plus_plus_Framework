...
*   @implements     Platform_Types.hpp_Artifact
*   @version 1.0.1
*
...
*   SW Version           : 1.0.1
*   Build Version        : S32V234_MCAL_1_0_1_RTM_ASR_REL_4_2_REV_0002_20180316
*
...
#define G_Gz  (9.7883105f)

//#define PRDUCT_DEBUGMODE
//#define SHOWSTATUSLOG
//#define ELOG_SAVEFILE
#define LOGON
//#define SKDYSDK
#define QXSDK
//#define ST9100_L1L2
...
static const char LocalIp[] = "10.0.0.48";
#define APP_VERSION_	"PT2_3"

#define PARTNUMBER_ID         "8075010ACN0100"
#define SOFTWARE_ID           "877CACN010  S.000"
#define SOFTWARE_ID_SUPPLIER  "V02.00.00.00"


#define MMCBLKP7_PATH	"/dev/mmcblk0p7"
/**
...
*                                      FILE VERSION CHECKS
==================================================================================================*/
#define ALIGN_4BYTES	__attribute__((packed,aligned(4)))
/*==================================================================================================
*                                           CONSTANTS
==================================================================================================*/
...
}FunctionSafety_ErrorType_Control_e;

typedef struct
{
	uint8 Major;
	uint16 Minor;
	uint8 Flag; //(0 == recover ,1 == error)
	FunctionSafety_ErrorType_Control_e Control;
}ALIGN_4BYTES FunctionSafety_ErrorType_e;
